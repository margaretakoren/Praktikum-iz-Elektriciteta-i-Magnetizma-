...
U1 <- c(2.0, 4.0, 6.4, 8.4, 10.8, 13.0)
U2 <- c(8.2, 17.0, 25.0, 33.4, 42.0, 60.0)
...
ggsave("graf_reziduali.pdf", plot = p2, width = 8, height = 4.5)

pdf("tablica.pdf", width = 8, height = 3)
grid.newpage()
grid.draw(tablica)
dev.off()

pdf("1.pdf", width = 8, height = 9)
